# Graph Report - EGYPT-TIME-MACHINE-FF  (2026-06-22)

## Corpus Check
- 252 files · ~1,235,746 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2181 nodes · 5137 edges · 144 communities (131 shown, 13 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 231 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65825c91`
...
Cohesion: 0.12
Nodes (33): apply_args(), balance_source_embedding(), clear_inference_pool(), convert_source_embedding(), extract_source_face(), forward_convert_embedding(), forward_swap_face(), get_inference_pool() (+25 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (86): Content, JobStatus, TableContent, TableHeader, Args, JobStatus, JobStep, JobStep (+78 more)
...
Cohesion: 0.06
Nodes (37): { ipcRenderer }, CameraCapture(), CameraCaptureProps, CFG, CORNER_COLORS, CORNERS, FeaturedGallery(), { ipcRenderer } (+29 more)
...
Cohesion: 0.08
Nodes (53): apply_args(), apply_edit(), calculate_distance_ratio(), clear_inference_pool(), edit_eye_gaze(), edit_eye_open(), edit_eyebrow_direction(), edit_face() (+45 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (39): apply(), get_step_choices(), listen(), remote_update(), render(), update(), update_step_index(), listen() (+31 more)

### Community 9 - "Community 9"
Cohesion: 0.10
Nodes (45): conditional_download(), has_video(), get_test_example_file(), get_test_examples_directory(), before_all(), test_get_audio_frame(), test_read_static_audio(), before_all() (+37 more)
...
Cohesion: 0.05
Nodes (57): render(), ExecutionDevice, detect_app_context(), resolve_execution_providers(), create_inference_providers(), create_value_and_unit(), detect_execution_devices(), detect_static_execution_devices() (+49 more)
...
Cohesion: 0.11
Nodes (34): JobStatus, get_test_job_file(), get_test_output_file(), is_test_job_file(), is_test_output_file(), test_batch_run_sources_to_targets(), test_batch_run_targets(), test_restore_expression_to_image() (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.13
Nodes (33): pre_process(), pre_process(), remote_update(), render(), pre_process(), pre_process(), pre_process(), pre_process() (+25 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (63): AudioBuffer, clear(), create_and_run_job(), listen(), remote_update(), render(), run(), start() (+55 more)

### Community 16 - "Community 16"
Cohesion: 0.14
Nodes (34): ColorMode, render(), create_empty_audio_frame(), is_windows(), Mask, Size, VisionFrame, process_stream_frame() (+26 more)

### Community 17 - "Community 17"
Cohesion: 0.11
Nodes (31): apply_args(), apply_restore(), clear_inference_pool(), forward_extract_feature(), forward_extract_motion(), forward_generate_frame(), get_inference_pool(), get_model_options() (+23 more)

### Community 18 - "Community 18"
Cohesion: 0.21
Nodes (25): clear_jobs(), init_jobs(), get_test_jobs_directory(), prepare_test_output_directory(), before_each(), test_modify_age_to_image(), test_modify_age_to_video(), before_each() (+17 more)

### Community 19 - "Community 19"
Cohesion: 0.14
Nodes (15): Component, ComponentName, listen(), remote_update(), render(), update_face_debugger_items(), listen(), listen() (+7 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (67): apply_args(), clear_inference_pool(), create_static_model_set(), forward(), get_inference_pool(), get_model_options(), get_model_size(), has_morph_input() (+59 more)
...
Cohesion: 0.28
Nodes (12): Resolution, Scale, ErrorCode, detect_image_resolution(), normalize_resolution(), restrict_image_resolution(), scale_resolution(), finalize_image() (+4 more)
...
Cohesion: 0.22
Nodes (17): InferencePool, ModelOptions, ProcessorOutputs, VisionFrame, blend_merge_frame(), clear_inference_pool(), enhance_frame(), forward() (+9 more)

### Community 27 - "Community 27"
Cohesion: 0.23
Nodes (27): Anchors, detect_faces(), detect_faces_by_angle(), detect_with_retinaface(), detect_with_scrfd(), detect_with_yolo_face(), detect_with_yunet(), forward_with_retinaface() (+19 more)

### Community 28 - "Community 28"
Cohesion: 0.10
Nodes (28): register_args(), _ArgumentGroup, register_args(), register_args(), register_args(), register_args(), register_args(), register_args() (+20 more)
...
Cohesion: 0.11
Nodes (24): process_frame(), AgeModifierInputs, process_frame(), FaceEditorInputs, create_faces(), get_average_face(), get_many_faces(), get_one_face() (+16 more)

### Community 34 - "Community 34"
Cohesion: 0.19
Nodes (23): collect_model_downloads(), conditional_optimize_contrast(), create_static_model_set(), detect_face_landmark(), detect_with_2dfan4(), detect_with_peppa_wutz(), estimate_face_landmark_68_5(), forward_fan_68_5() (+15 more)
...
Cohesion: 0.27
Nodes (10): create_directory(), get_file_size(), is_directory(), is_file(), remove_directory(), get_hash_path(), validate_hash(), get_test_outputs_directory() (+2 more)

### Community 38 - "Community 38"
Cohesion: 0.13
Nodes (24): ApplyStateItem, Args, ArgumentParser, DownloadScope, InferencePool, ModelOptions, ModelSet, ProcessorOutputs (+16 more)
...
Cohesion: 0.15
Nodes (19): apply_args(), clear_inference_pool(), forward(), get_inference_pool(), get_model_options(), modify_age(), normalize_extend_frame(), post_process() (+11 more)
...
Cohesion: 0.09
Nodes (32): Fps, ErrorCode, count_trim_frame_total(), detect_video_resolution(), predict_video_frame_total(), restrict_trim_frame(), restrict_video_fps(), restrict_video_resolution() (+24 more)
...
Cohesion: 0.32
Nodes (6): render(), update(), clear_static_faces(), File, Image, Video
...
Cohesion: 0.27
Nodes (10): render(), update(), get_first(), Audio, File, Image, filter_audio_paths(), filter_image_paths() (+2 more)
...
Cohesion: 0.17
Nodes (14): fatal_exit(), graceful_exit(), hard_exit(), signal_exit(), ErrorCode, FrameType, Any, ModuleType (+6 more)

### Community 52 - "Community 52"
Cohesion: 0.09
Nodes (27): create_static_model_set(), create_static_model_set(), create_static_model_set(), create_static_model_set(), create_static_model_set(), pre_check(), resolve_download_url(), create_static_model_set() (+19 more)
...
Cohesion: 0.19
Nodes (12): get_static_download_size(), open_curl(), ping_static_url(), resolve_download_url_by_provider(), Command, DownloadProvider, Popen, test_enhance_frame_to_image() (+4 more)
...
Cohesion: 0.07
Nodes (19): BenchmarkMode, BenchmarkResolution, render(), update_benchmark_mode(), update_benchmark_resolutions(), render(), render(), render() (+11 more)
...
Cohesion: 0.10
Nodes (24): BenchmarkCycleSet, listen(), render(), update_preview_frame_slider(), listen(), remote_update(), render(), update_trim_frame() (+16 more)
...
Cohesion: 0.29
Nodes (12): clear_and_update_preview_image(), create_face_by_face(), extract_crop_frame(), prepare_output_frame(), process_preview_frame(), update_preview_image(), AudioFrame, Face (+4 more)
...
Cohesion: 0.24
Nodes (10): pre_check(), conditional_download_hashes(), conditional_download_sources(), validate_hash_paths(), validate_source_paths(), collect_model_downloads(), pre_check(), DownloadSet (+2 more)

### Community 91 - "Community 91"
Cohesion: 0.33
Nodes (7): get_face_store(), get_static_faces(), set_static_faces(), Face, VisionFrame, create_hash(), FaceStore
...
## Knowledge Gaps
- **452 isolated node(s):** `{ ipcRenderer }`, `{ ipcRenderer }`, `CFG`, `Phase`, `radialGlowTexture` (+447 more)
...
- **Why does `get_test_example_file()` connect `Community 9` to `Community 33`, `Community 2`, `Community 37`, `Community 43`, `Community 13`, `Community 142`, `Community 141`, `Community 15`, `Community 48`, `Community 18`, `Community 83`, `Community 16`, `Community 55`, `Community 63`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `register_ui_component()` connect `Community 19` to `Community 14`, `Community 16`, `Community 30`, `Community 31`, `Community 32`, `Community 39`, `Community 41`, `Community 42`, `Community 45`, `Community 48`, `Community 49`, `Community 51`, `Community 53`, `Community 54`, `Community 58`, `Community 60`, `Community 63`, `Community 64`, `Community 65`, `Community 67`, `Community 68`, `Community 71`, `Community 76`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `is_video()` connect `Community 14` to `Community 3`, `Community 37`, `Community 39`, `Community 72`, `Community 73`, `Community 9`, `Community 43`, `Community 45`, `Community 15`, `Community 16`, `Community 60`, `Community 63`?**
